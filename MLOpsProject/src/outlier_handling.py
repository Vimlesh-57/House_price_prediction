...
class ZScoreOutlierDetection(OutlierHandlingStrategy):
...
class IQROutlierDetection(OutlierHandlingStrategy):
    def detect_outliers(self, df: pd.DataFrame) -> pd.DataFrame:
...
class OutlierDetector:
    def __init__(self, strategy: OutlierHandlingStrategy):
        self._strategy = strategy

    def set_strategy(self, strategy: OutlierHandlingStrategy):
